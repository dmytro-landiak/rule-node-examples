...
@Data
public class TbPrologisTransformTelemetryToNewFormatNodeConfiguration
    ...
    public TbPrologisTransformTelemetryToNewFormatNodeConfiguration defaultConfiguration() {
        TbPrologisTransformTelemetryToNewFormatNodeConfiguration configuration
                = new TbPrologisTransformTelemetryToNewFormatNodeConfiguration();
        configuration.setCountOfDevicesAtATime(1000);
